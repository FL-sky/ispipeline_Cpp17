...
def test_case_thumbnail(imgstr,height,width,max_bit):
    
    b = np.fromfile(imgstr, dtype ="uint16")
    ...
    out=b
    out=out/2**max_bit
    raw_image_show_thumbnail(out,height,width)
...
if __name__ == "__main__":
    ...
    # test_case_3D()
    prefix = "f:/SoftDocument/clion/ispipelineCpp17/data/"
    img = "connan_raw14.raw"
    width=6080
    height= 4044
    max_bit=14
    test_case_thumbnail(prefix+img, height,width,max_bit)