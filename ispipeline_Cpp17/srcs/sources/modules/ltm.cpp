...
//            bgr_in[3 * pixel_idx + 2] = static_cast<int32_t>(bgr_in[3 * pixel_idx + 2] * ratio);
            auto bgr_in0 = (bgr_in[3 * pixel_idx + 0] * ratio);
            auto bgr_in1 = (bgr_in[3 * pixel_idx + 1] * ratio);
            auto bgr_in2 = (bgr_in[3 * pixel_idx + 2] * ratio);


            bgr_out[3 * pixel_idx + 0] = static_cast<int32_t>(max_out_val * bgr_in0 / max_scale_val);
            bgr_out[3 * pixel_idx + 1] = static_cast<int32_t>(max_out_val * bgr_in1 / max_scale_val);
            bgr_out[3 * pixel_idx + 2] = static_cast<int32_t>(max_out_val * bgr_in2 / max_scale_val);
